...
import com.orangesoft.officium.empleadoApp.ofertasLaborales.infraestructura.persistencia.PuertoListaOfertasLaboralesActivasImp;
...
public class TestIntegracionCasoUsoObtenerListaOfertasLaboralesActivasEmpleado {
    ...
    public void debeDevolverListaDeOfertasLaboralesActivas() {
        ...
        PuertoListaOfertasLaboralesActivas puertoListaOfertasLaboralesActivas = new PuertoListaOfertasLaboralesActivasImp(repositorioOfertaLaboralActiva, new MapeadorQDTOAOfertaLaboralImpl());
        ...
        Tupla<NombreEmpresa, OfertaLaboral> ofertaLaboralTuplaObtenida = casoUsoObtenerListaOfertasLaboralesActivasEmpleado.obtenerListaOfertasLaboralesActivasEmpleado().get(0);
