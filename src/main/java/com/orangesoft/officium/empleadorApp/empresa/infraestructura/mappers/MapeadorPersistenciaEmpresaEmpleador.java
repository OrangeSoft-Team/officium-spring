...
@Mapper(componentModel = "spring", imports = {UUID.class,Empresa.class,IdEmpresa.class,NombreEmpresa.class,CorreoElectronicoEmpresa.class,
    DireccionEmpresa.class,CodigoPostalEmpresa.class, IdPais.class, IdCiudad.class, IdEstado.class
})
