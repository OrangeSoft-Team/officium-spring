...
@Repository
public interface RepositorioObtenerHabilidadOfertaLaboral extends JpaRepository<PersistenciaHabilidadOfertaLaboral, PersistenciaIdHabilidadOfertaLaboral> {
