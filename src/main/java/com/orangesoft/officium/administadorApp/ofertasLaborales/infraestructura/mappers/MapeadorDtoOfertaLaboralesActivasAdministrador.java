...
public abstract class MapeadorDtoOfertaLaboralesActivasAdministrador {
    ...
    @Mapping(target = "duracionEstimadaOfertaLaboral", expression = "java(new DuracionEstimadaOfertaLaboral(dtoOfertasLaboralesActivasAdministrador.getDuracionEstimadaValor(), PeriodoTiempo.obtenerPeriodoTiempo(dtoOfertasLaboralesActivasAdministrador.getDuracionEstimadaEscala())))")
